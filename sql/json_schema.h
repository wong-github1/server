...
class Json_schema_keyword : public Sql_alloc
{
  public:
    ...
    */
    virtual bool validate(const json_engine_t *je, MEM_ROOT *current_mem_root, const uchar *k_start= NULL,
                          const uchar *k_end= NULL)
    { return false; }
    virtual bool handle_keyword(THD *thd, MEM_ROOT *current_mem_root, json_engine_t *je,
...
class Json_schema_multiple_of : public Json_schema_keyword
{
  ...
  public:
    bool validate(const json_engine_t *je, MEM_ROOT *current_mem_root, const uchar *k_start= NULL,
                  const uchar *k_end= NULL) override;
    bool handle_keyword(THD *thd, MEM_ROOT *current_mem_root, json_engine_t *je,
                        const char* key_start,
                        const char* key_end,
...
class Json_schema_logic : public Json_schema_keyword
{
  ...
  public:
    ...
    bool check_validation(const json_engine_t *je, MEM_ROOT *current_mem_root, const uchar *k_start= NULL,
                          const uchar *k_end= NULL);
};
