...
static int assoc_array_tree_cmp(void *arg, const Assoc_array_data *lhs,
                         const Assoc_array_data *rhs)
{
  return sortcmp(lhs->key, rhs->key, (CHARSET_INFO*)arg);
}


static int assoc_array_tree_del(Assoc_array_data *data, TREE_FREE, void*)
{
  ...
  :Field_null(ptr_arg, 0, Field::NONE, field_name_arg, &my_charset_bin)
{
  ...
  init_tree(&m_tree, 0, 0,
            sizeof(Assoc_array_data), (qsort_cmp2)assoc_array_tree_cmp,
	          (tree_element_free)assoc_array_tree_del, NULL,
