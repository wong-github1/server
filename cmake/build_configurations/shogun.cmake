...
# Flags used by the compiler during Shogun builds
SET(COMPILER_FLAGS_SHOGUN "-DDBUG_OFF ${COMPILER_FLAGS_SHOGUN}")

if (NOT CMAKE_SYSTEM_NAME STREQUAL "Linux")
  message(FATAL_ERROR "Shogun optimization is only for Linux!")
endif()
...
if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
  if (_vendor_id STREQUAL "GenuineIntel")
    set(COMPILER_FLAGS_SHOGUN "-mbranches-within-32B-boundaries ${COMPILER_FLAGS_SHOGUN}")
  elseif (_vendor_id STREQUAL "AuthenticAMD")
    set(COMPILER_FLAGS_SHOGUN "-march=znver2 -mtune=znver2 ${COMPILER_FLAGS_SHOGUN}")
  endif()
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  if (_vendor_id STREQUAL "GenuineIntel")
    set(COMPILER_FLAGS_SHOGUN "-Wa,-mbranches-within-32B-boundaries ${COMPILER_FLAGS_SHOGUN}")
  elseif (_vendor_id STREQUAL "AuthenticAMD")
    set(COMPILER_FLAGS_SHOGUN "-Wa,-march=znver2 -Wa,-mtune=znver2 ${COMPILER_FLAGS_SHOGUN}")
  endif()
...
# Flags used by the linker during SHOGUN builds
SET(LINKER_FLAGS_SHOGUN
    "-z relro -z now ${LINKER_FLAGS_SHOGUN}")
SET(CMAKE_CXX_FLAGS_SHOGUN
    "${CMAKE_CXX_FLAGS_RELEASE} ${COMPILER_FLAGS_SHOGUN}"
    CACHE STRING "Flags used by C++ compiler during SHOGUN builds"
    FORCE)
SET(CMAKE_C_FLAGS_SHOGUN
    "${CMAKE_C_FLAGS_RELEASE} ${COMPILER_FLAGS_SHOGUN}"
    CACHE STRING "Flags used by C compiler during SHOGUN builds"
    FORCE)
SET(CMAKE_ASM_FLAGS_SHOGUN
    "${CMAKE_ASM_FLAGS_RELEASE} ${COMPILER_FLAGS_SHOGUN}"
    CACHE STRING "Flags used by assembler during SHOGUN builds"
    FORCE)
SET(CMAKE_EXE_LINKER_FLAGS_SHOGUN
    "${CMAKE_EXE_LINKER_FLAGS_RELEASE} ${LINKER_FLAGS_SHOGUN}"
    CACHE STRING "Flags used for linking binaries during SHOGUN builds"
    FORCE)
SET(CMAKE_SHARED_LINKER_FLAGS_SHOGUN
    "${CMAKE_SHARED_LINKER_FLAGS_RELEASE} ${LINKER_FLAGS_SHOGUN}"
    CACHE STRING "Flags used by shared libraries linker during SHOGUN builds"
    FORCE)
SET(CMAKE_STATIC_LINKER_FLAGS_SHOGUN
    "${CMAKE_STATIC_LINKER_FLAGS_RELEASE}"
    CACHE STRING "Flags used by static libraries linker during SHOGUN builds"
    FORCE)
SET(CMAKE_MODULE_LINKER_FLAGS_SHOGUN
    "${CMAKE_MODULE_LINKER_FLAGS_RELEASE} ${LINKER_FLAGS_SHOGUN}"
    CACHE STRING "Flags used by module libraries linker during SHOGUN builds"
    FORCE)
SET(CMAKE_BUILD_TYPE SHOGUN
    CACHE STRING "Choose the type of build : None Debug Release RelWithDebInfo MinSizeRel SHOGUN"
    FORCE)
MARK_AS_ADVANCED(FORCE
    CMAKE_CXX_FLAGS_SHOGUN
    CMAKE_C_FLAGS_SHOGUN
    CMAKE_ASM_FLAGS_SHOGUN
    CMAKE_EXE_LINKER_FLAGS_SHOGUN
    CMAKE_SHARED_LINKER_FLAGS_SHOGUN
    CMAKE_STATIC_LINKER_FLAGS_SHOGUN
    CMAKE_MODULE_LINKER_FLAGS_SHOGUN)
